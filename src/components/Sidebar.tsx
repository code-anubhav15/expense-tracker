...
const navItems = [
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path d="M3 10.5L12 4l9 6.5V20a1 1 0 0 1-1 1h-5v-5h-6v5H4a1 1 0 0 1-1-1V10.5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        ...
        <path d="M12 19v2a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
    ...
    <aside className="w-64 h-screen bg-[#44506a] text-white flex flex-col py-8 gap-8 font-sans">
      ...
      <div className="flex items-center gap-4 mb-3 ml-5">
        ...
        <div className="flex flex-col">
          <span className="text-base font-semibold leading-tight">John Doe</span>
          <span className="text-xs text-[#bfc9da] leading-tight">john.doe@email.com</span>
        </div>
      </div>

      {/* NAVIGATION */}
      <div>
        <div className="text-xs font-bold text-[#bfc9da] mb-4 tracking-wider ml-6">NAVIGATION</div>
      ...
      {/* ACCOUNT */}
      <div>
        <div className="text-xs font-bold text-[#bfc9da] mb-4 ml-6 tracking-wider">ACCOUNT</div>
        <nav className="flex flex-col gap-1">
